...
public class DetailFraend extends AppCompatActivity {
    //Explicit
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_fraend);
        //bind Widget
        ...
        Picasso.with(DetailFraend.this).load(getIntent().getStringExtra("Image")).into(imageView);
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:=0887098866"));
                if (ActivityCompat.checkSelfPermission(DetailFraend.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
